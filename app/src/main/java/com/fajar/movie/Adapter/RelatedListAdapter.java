...
public class RelatedListAdapter extends RecyclerView.Adapter<RelatedListAdapter.Holder> {

    private List<MovieListModel> mListData;
    private Context mContext;


    public RelatedListAdapter(List<MovieListModel> mListData, Context mContext) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.listitem_related, parent, false);
